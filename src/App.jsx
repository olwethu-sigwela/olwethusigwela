...
function ProjectList(){
  ...
  <>
    ...
    <div className="container mx-auto bg-slate-200 rounded-2xl p-5 flex flex-wrap justify-center gap-4">
      <Project src="./selenium-database.png" caption = "Selenium Database" description="Property valuation application for a growing start-up. In beta testing phase." stack="Django, Flask, React, Bootstrap, Firebase, Sentry" link="https://selenium-database-cwov.onrender.com/"/>
